...
public class CustomUserDetailsService implements UserDetailsService{
    ...
    // private String getLdopRequest(String id, String pwd) {
	// 	String params = "user=" + id + "&pwd=" + pwd;
    private String getLdopRequest(String id) {
		String params = "user=" + id;
		String url = "http://localhost:3000/robots.txt?" + params;
        String method = "GET";
		String result = "";
        ...
        //해당 정보를 확인합니다.
		log.debug("GET getLdopRequest = " + result);
        return result;
	}
